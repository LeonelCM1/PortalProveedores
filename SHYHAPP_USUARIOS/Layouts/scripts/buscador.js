...
var extension = 'aspx'			//extension de las paginas del site (htm o html)
...
function IniciaBuscador(palabraClave, paginacion, nuevaBusqueda) {
    ...
    //var ligas =  paginacion * resXpag
    if (resfinal > 0 && resfinal <= 5) {
        for (var n = 0; n <= paginacion -1; n++) {
